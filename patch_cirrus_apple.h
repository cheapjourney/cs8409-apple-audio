...
struct cs8409_apple_spec {
	...
	/* Per-model callback overrides (Dell & Apple share same offset after gen) */
	struct {
 ...
 */
	...
	//codec->patch_ops = cs8409_cs42l83_patch_ops;
        ...
        if (explicit)
               ...
               spec->callbacks.unsol_event = cs_8409_cs42l83_jack_unsol_event;
               spec->callbacks.init = cs_8409_apple_init;
               spec->callbacks.build_controls = cs_8409_apple_build_controls;
               spec->callbacks.build_pcms = cs_8409_apple_build_pcms;
               spec->callbacks.remove = cs_8409_apple_free;
               spec->callbacks.suspend = cs_8409_apple_suspend;
               spec->callbacks.resume = cs_8409_apple_resume;
